...
Source:		ftp://ftp.perl.org/pub/CPAN/modules/by-module/SGML/SGML-Grove-%{version}.tar.gz
...
%description
SGML-Grove provides an interface for accessing and manipulating SGML, XML,
HTML and other document instances after they've been built by a parsing or
grove building module like SGML::SPGroveBuilder, Pod::GroveBuilder, etc.
...
cp -a entities     $RPM_BUILD_ROOT/usr/src/examples/%{name}-%{version}
